                ...
                <tbody>
                  <?php
                    ...
                    try{
                      ...
                      $stmt->execute();
                      foreach($stmt as $row){
                        $image = (!empty($row['photo'])) ? '../images/'.$row['image'] : '../images/profile.jpg';
                        echo "
                          <tr>
                            <td>
                              <img src='".$image."' height='30px' width='30px'>
                              <span class='pull-right'><a href='#edit_photo' class='photo' data-toggle='modal' ><i class='fa fa-edit'></i></a></span>
                            </td>
                            <td>".$row['email']."</td>
                            <td>".$row['Prenon'].' '.$row['nom']."</td>
                            
                            
                            <td>
                              <a href='cart.php' class='btn btn-info btn-sm btn-flat'><i class='fa fa-search'></i> Cart</a>
